...
// Source: github.com/luxfi/platformvm/state (interfaces: StakerIterator)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/platformvm/state/mock_staker_iterator.go github.com/luxfi/platformvm/state StakerIterator
//
